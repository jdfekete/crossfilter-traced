(function() {
    ...
    function traceMetadata(action, label, details) {
	return traceEvent("_trace", action, label, details);
    }

    function traceEvent(cat, action, label, details) {
	if (starting) {
	    starting = false;
	    _sending = [];
    ...
    function traceEventDeferred(delay, cat, action, label, details) {
	return window.setTimeout(function() {
            traceEvent(cat, action, label, details);
	}, delay);
	return trace;
    }
